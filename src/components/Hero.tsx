...
export default function Hero() {
  ...
  const tabletH = Math.min(480, Math.max(420, (viewportW || 900) * 0.48));

  return (
    <section
      id="home"
      className="relative min-h-[100svh] flex flex-col justify-center pt-32 pb-16 bg-brand-light w-full max-w-full overflow-hidden"
    >
      <div
        className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none"
        style={{
          backgroundImage:
            "url('data:image/svg+xml,%3Csvg width=\\'60\\' height=\\'60\\' viewBox=\\'0 0 60 60\\' xmlns=\\'http://www.w3.org/2000/svg\\'%3E%3Cg fill=\\'none\\' fill-rule=\\'evenodd\\'%3E%3Cg fill=\\'%23182019\\' fill-opacity=\\'1\\'%3E%3Cpath d=\\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')",
        }}
      />
      ...
      <div className="container mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10 w-full max-w-full">
        ...
        >
          ...
          >
            ...
            <p className="text-brand-dark/70 font-semibold tracking-widest text-[10px] sm:text-xs uppercase whitespace-nowrap">
              Systems Online &bull; Automation &bull; Web
            </p>
          </motion.div>
          ...
          >
            BUILD POWERFUL
            <br />
            <span className="text-brand-accent">AUTOMATED</span> WEB
            <br />
            SOLUTIONS THAT
            <br />
            DRIVE REAL RESULTS.
        ...
        <div
          ...
          className="relative w-full lg:w-[55%] flex items-center justify-center overflow-hidden min-w-0"
          style={{
