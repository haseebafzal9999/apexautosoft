      ...
      <div className="container mx-auto px-6 md:px-12 max-w-5xl">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            >
              ApexAutosoft focuses on building efficient, scalable digital systems that connect web applications, APIs, communication platforms, automation tools, and AI.
            </motion.p>
